...
export default function PageHeader({ subtitle, title, actionNode }) {
  return (
    <header 
      className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[1400px] z-50 bg-mint/70 backdrop-blur-xl border-b border-forest-deepest/5 px-4 md:px-8 flex items-center justify-between shadow-[0_10px_40px_-15px_rgba(6,9,7,0.1)] pt-[calc(env(safe-area-inset-top)+1rem)] pb-3"
    >
      {/* GAUCHE : stacked subtitle & title */}
